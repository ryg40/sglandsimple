...
- [ ] **S31.intake.1 — Backend: unassigned incoming-ticket scan + entity extraction + workflow match + connector enrichment**
...
- [ ] **S31.bubble.1 — Standup cockpit: conditional "Incoming tickets" bubble with enrichment + one-click workflow kickoff (dry-run)**
...
- [ ] **S32.ldap.1 — Faked python-ldap directory module + 200-user fixture with enterprise attributes**
...
- [ ] **S32.enrich.1 — Identity-driven hub enrichment: team inference + activity/context lookup**
...
- [ ] **S32.s31.1 — Wire identity enrichment into the Stage 31 incoming-tickets bubble**
